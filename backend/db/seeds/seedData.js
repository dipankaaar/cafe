...
export const initialCategories = [
  ...
  { id: "cat-coffee", name: "Coffee", slug: "coffee", icon: "Coffee", color: "#6F4E37", itemCount: 0, isActive: true },
  { id: "cat-cold-brews", name: "Cold Brews", slug: "cold-brews", icon: "CupSoda", color: "#0EA5E9", itemCount: 0, isActive: true },
  { id: "cat-teas", name: "Teas", slug: "teas", icon: "Leaf", color: "#15803D", itemCount: 0, isActive: true },
  { id: "cat-bakery", name: "Bakery", slug: "bakery", icon: "Croissant", color: "#D97706", itemCount: 0, isActive: true }
];
...
export const initialStaff = [
  { id: "staff-1", name: "Alex Walker", email: "admin@dinenos.com", password: "admin123", pin: "1234", phone: "+61 400 111 222", role: "Admin", status: "Active", joiningDate: "2022-01-15", avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
  { id: "staff-2", name: "Samantha Reed", email: "manager@dinenos.com", password: "manager123", pin: "2222", phone: "+61 400 222 333", role: "Manager", status: "Active", joiningDate: "2023-03-01", avatar: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&auto=format&fit=crop&q=80" },
  { id: "staff-3", name: "David Chen", email: "cashier@dinenos.com", password: "cashier123", pin: "3333", phone: "+61 400 333 444", role: "Cashier", status: "Active", joiningDate: "2024-02-10", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80" },
  { id: "staff-4", name: "Gordon Marco", email: "kitchen@dinenos.com", password: "kitchen123", pin: "4444", phone: "+61 400 444 555", role: "Kitchen Staff", status: "Active", joiningDate: "2023-06-20", avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80" },
  { id: "staff-5", name: "Elena Silva", email: "waiter@dinenos.com", password: "waiter123", pin: "5555", phone: "+61 400 555 666", role: "Waiter", status: "Active", joiningDate: "2024-05-12", avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&auto=format&fit=crop&q=80" }
];
