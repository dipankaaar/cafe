...
export default function GallerySection() {
  ...
  return (
    <section id="gallery" aria-label="Cafe gallery" className="bg-[#111111] relative">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
              <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                <span className="text-xs uppercase tracking-widest text-[#DD5903] font-bold">Petuk Adda Cafe Moments</span>
      ...
      {activeImage && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label={`Photo viewer — ${activeImage.title}`}
        >
          <button
            onClick={() => setActiveImage(null)}
